...
#SBATCH --job-name=RandPred_cheminf
...
srun -N1 --ntasks=1 --cpus-per-task=4 --mem=150G --time=36:00:00 --exclusive \
...
# sbatch --export=ALL,SETUP=scripts/slurm/projects/complement.csv scripts/slurm/sbatch_cheminf_auto_randomized.sh
