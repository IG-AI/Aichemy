...
from cheminf.src.cheminf.postprocessing import ChemInfPostProc
from tests.test_utils import MockController


def test_postproc(percentage: float, significance: float,
    ...
    for mode in ALL_MODES:
        for classifier_type in CLASSIFIER_TYPES:
            if classifier_type == 'nn':
                ...
                postproc = ChemInfPostProc.initialize(controller)
