...
from cheminf.src.cheminf.preprocessing import ChemInfPreProc
from tests.test_utils import MockController


def test_preproc(percentage: float, significance: float,
    ...
    for mode in ALL_MODES:
        for classifier_type in CLASSIFIER_TYPES:
            if classifier_type == 'nn':
                ...
                postproc = ChemInfPreProc.initialize(controller)
