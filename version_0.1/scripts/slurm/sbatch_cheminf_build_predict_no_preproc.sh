...
#SBATCH --job-name=real_case_model_comp_cheminf
...
# sbatch --export=ALL,SETUP=scripts/slurm/projects/complement_model.csv scripts/slurm/sbatch_cheminf_build_predict_no_preproc.sh